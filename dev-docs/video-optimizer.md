...
to its own repository, videocrunch (not yet published; cloned as a sibling
checkout, `../videocrunch`). Arcade invokes it as a subprocess
...
[`docs/technical-reference.md`](../../videocrunch/docs/technical-reference.md)
